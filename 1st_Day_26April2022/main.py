...
#Assignment-1 :In this project, star pattern I have made and then taken screenshot of every iteration after 5 sec delay
#            using python library and tkinter also. Screenshots are also there which shows how after every 5 sec picture
#            is taken of star pattern at each iteration.
